...
# feature map
def to_xFeature(name, offset="(0,0,0)", to="(0,0,0)", width=2, height=15, depth=15, opacity=0.5, caption=" "):
    return r"""
...
def to_zFeature(name, offset="(0,0,0)", to="(0,0,0)", width=2, height=15, depth=15, opacity=0.5, caption=" "):
    return r"""
\pic[shift={""" + offset + """}] at """ + to + """ 
    {Box={
        name=""" + name + """,
...
def to_zf(name, offset="(0,0,0)", to="(0,0,0)", height=10, width=10, depth=4, opacity=0.5, caption=" "):
    return r"""
    \pic[shift={""" + offset + """}] at """ + to + """ 
        {Box={
            name=""" + name + """,
...
def to_xf(name, offset="(0,0,0)", to="(0,0,0)", height=15, width=15, depth=4, opacity=0.5, caption=" "):
    return r"""
    \pic[shift={""" + offset + """}] at """ + to + """ 
        {Box={
            name=""" + name + """,
...
def to_ff(name, offset="(0,0,0)", to="(0,0,0)", height=15, width=15, depth=4, opacity=0.5, caption=" "):
    return r"""
    \pic[shift={""" + offset + """}] at """ + to + """ 
        {Box={
            name=""" + name + """,
